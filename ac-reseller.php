        ...
        else
        {
            ...
            <div class="affiliate-getstarted" id="reseller-getstarted">
                ...
                <div class="green-info" style="margin-bottom:25px;">
                    <div class="padding20">
                        <i class="ion-ribbon-b" aria-hidden="true" style="    margin: 0px 35px 17px 20px;"></i>
                        <strong><?php echo __("website/account/reseller-tx1"); ?></strong><br>
                        <?php echo __("website/account/reseller-tx2"); ?>
                    </div>
                </div>
