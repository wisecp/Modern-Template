...
<?php if($list): ?>
    <table width="100%" class="table table-striped table-borderedx table-condensed nowrap" id="products">
        ...
        <tr>
            ...
            <th align="center">Oluşturma Tarihi</th>
                ...
                foreach($list AS $r=>$row){
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <?php if(isset($row["options"]["name"])): ?>
                                <br>
                                <?php echo $row["options"]["name"]; ?> - <?php echo $row["options"]["identity"]; ?>
                            <?php endif; ?>
                        </td>
...
<?php else: ?>
    <div id="orders-none">
        <?php echo __("website/account_products/empty-list-sms"); ?>
    </div>
<?php endif; ?>
